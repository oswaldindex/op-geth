...
import (
	...
	"github.com/ethereum/go-ethereum-op/crypto/signify"
	"github.com/ethereum/go-ethereum-op/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/ethereum/go-ethereum-op/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/ethereum/go-ethereum-op/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/ethereum/go-ethereum-op/params.gitTag="+env.Tag)
	}
